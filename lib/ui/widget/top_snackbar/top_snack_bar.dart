...
class _TopSnackBarState extends State<TopSnackBar> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return AnimatedPositioned(
      ...
      top: topPosition,
      left: ResponsiveWidget.isSmallScreen(context) ? 16 : ResponsiveWidget.isMediumScreen(context) ? 100 : 300,
      right: ResponsiveWidget.isSmallScreen(context) ? 16 : ResponsiveWidget.isMediumScreen(context) ? 100 : 300,
